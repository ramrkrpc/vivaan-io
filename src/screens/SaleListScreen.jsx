            ...
            <button onClick={() => setFilter('overdue')}
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-500">Due date passed — collect payment now</p>
                </div>
              </div>
              ...
              <div key={inv.id} className={`p-4 ${isOverdue(inv) ? 'bg-red-50/40' : ''}`}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex gap-3 text-xs">
                    {(inv.paid ?? 0) > 0 && <span className="text-green-600">✓ ₹{formatCurrency(inv.paid)} rcvd</span>}
