  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="px-6 py-3 border-b border-gray-200 bg-white shrink-0 flex items-center justify-between">
        <h1 className="text-base font-semibold text-gray-800">Payment Out</h1>
      ...
      <div className="flex-1 overflow-auto bg-gray-50 p-5">
        {showForm && (
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-4 max-w-2xl">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Record Payment Made</h2>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="number" value={form.amount} onChange={e => setF('amount', e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-teal-400" placeholder="0.00" />
              </div>
              <div>
              ...
              <div>
                ...
                <input value={form.notes} onChange={e => setF('notes', e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-teal-400" placeholder="Optional" />
              </div>
            </div>
          ...
          {payments.length === 0 ? (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  {['Date', 'Supplier', 'Invoice', 'Amount', 'Mode', 'Notes'].map(h => (
